...
class ModeloBase(models.Model):
    ...
    fecha_creacion = models.DataField('Fecha de Creación', auto_now =_False, auto_now_add = True)
    fecha_modificacion = models.DateField('Fecha de Modificación', auto_now=True , auto_now_add= False)
    fecha_modificacion = models.DateField('Fecha de Eliminación', auto_now=True , auto_now_add= False)
...
class Post(ModeloBase):
    ...
    fecha_publicacion= models.DateField('Fecha de Publicaión')
...
class Contacto(ModeloBase):
    ...
    apellidos= models.CharField('Apellidos', max_length= 120)
    email = models.EmailField('Correo Electrónico', max_length= 200)
    asunto = models.TextField('Asunto', max_length=100)
    mensaje = models.CharField('Mensaje')
